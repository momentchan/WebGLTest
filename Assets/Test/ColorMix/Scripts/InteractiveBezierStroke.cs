...
public class InteractiveBezierStroke : Stroke
{
    ...
    private InteractiveBezierStrokeGenerator generator;
    ...
    public void Setup(InteractiveBezierStrokeGenerator generator)
    {
